...
namespace SimpleMusicStore.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var address = new Address { Country = Input.Country, City = Input.City, Street = Input.Street };
                var user = new SimpleUser { UserName = Input.Email, Email = Input.Email, Address = address };
